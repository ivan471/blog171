...
<div class="col-md mb-5 ftco-animate">
  ...
  <form action="/blog/subedit/<?=$blog_ID?>" method="post">
    <div class="form-group">
      ...
      <input type="text" class="form-control" placeholder="Nama Judul" name="judul" value="<?=$judul?>">
    </div>
    <div class="form-group">
      <label for="email" class="sr-only">Isi</label>
      <textarea cols="20" rows="10" class="form-control" placeholder="Isi Blog" name="isi" ><?=$isi?></textarea>
    </div>
    <br>
    <div class="form-group">
